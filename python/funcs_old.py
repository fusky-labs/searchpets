...
class Housepets:
    ...
    def get_comics(self, year: int | str):
        """
        ...
        comics = page_soup.find_all("a", {"rel": "bookmark", "href": re.compile("^https://")})
        return comics
    ...
    def get_comic_metadata(self, comic_tag, index):
        ...
        if len(characters) != 0: character_str = ",".join(characters).lower()
    ...
    def get_comic_data(self, ch_link, pages_amount):
        ...
        """
        if pages_amount != 1:
            ch_link = f"{ch_link}page/{pages_amount}/"
    ...
    def get_chapter_entries(self):
        ...
        for chapters in chapter_dropdown:
            ...
            first_chapter_comics.update({
                ...
                first_comic[SLICE_URLL:-1]: name_parse
